...
class ExecutionEngine:
    ...
    def place_limit(self, symbol: str, price: float, qty: float, side: str, post_only=None, reduce_only=None):
        # placeholder for real exchange integration
        return {"cl_id": f"LIM-{symbol}-{side}", "price": price, "qty": qty, "side": side}
